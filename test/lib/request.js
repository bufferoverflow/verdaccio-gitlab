...
export class PromiseAssert extends Promise<any> implements IRequestPromise {
  ...
  status(expected: number) {
    ...
    return injectResponse(this, this.then((body) => {
      try {
...
const injectResponse = (smartObject: any, promise: Promise<any>): Promise<any> => {
  // $FlowFixMe
...
const smartRequest = (options: any): Promise<any> => {
